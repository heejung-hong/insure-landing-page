...
export default function Plans() {
  return (
    <div>
      ...
      />
      <div className="relative w-[375px] h-[500px] desktop:w-[1440px] desktop:h-[600px] bg-violet-dk desktop:m-auto">
        <img
          src={bgleftmobile}
          alt="wave lines"
        ...
        <img
          src={bgleftdesktop}
          alt="wave lines"
          className="absolute hidden desktop:block top-[430px]"
        />
        <div className="absolute top-[100px] inset-x-0 desktop:hidden">
          ...
          <div className="w-[146px] h-[40px] border-solid border-2 border-white content-center m-auto mt-8 hover:bg-white text-white hover:text-black cursor-pointer font-bold text-[13px] tracking-widest">
            VIEW PLANS
          </div>
        </div>
        ...
        <div className="absolute top-[100px] left-[170px] hidden desktop:block">
          <hr className="border-[#979797] w-[150px] h-[1px] mb-[50px] ml-0"></hr>
          ...
          <div className="w-[146px] h-[40px] border-solid border-2 border-white content-center mt-8 hover:bg-white text-white  hover:text-black cursor-pointer font-bold text-[13px] tracking-widest">
            VIEW PLANS
          </div>
        </div>
        <img
          src={imagedesktop}
          alt="family of four"
          className="absolute z-10 w-[540px] h-[650px] hidden desktop:block top-[100px] right-[170px]"
        />
        <img
          src={bgrightmobile}
          alt="wave lines"
          className="absolute top-[347px] right-0 desktop:hidden"
        />
        <img
          src={bgrightdesktop}
          alt="wave lines"
          className="absolute top-[347px] desktop:-top-[80px] right-0 hidden desktop:block"
        />
      </div>
    </div>
  );
