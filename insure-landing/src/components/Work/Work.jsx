    ...
    <div className="w-[327px] h-[544px] desktop:w-[100%] content-center justify-self-center">
      <div className="relative w-[327px] h-[344px] desktop:w-[1110px] desktop:h-[250px] desktop:m-auto bg-violet-dk">
        ...
        <div className="absolute top-[72px] inset-x-0 desktop:flex">
          ...
          <div className="w-[146px] h-[40px] desktop:w-[160px] border-solid border-2 border-white content-center m-auto mt-10 desktop:mt-8 desktop:mr-[80px] text-white hover:text-black hover:bg-white cursor-pointer">
            <div className="font-bold text-[13px] tracking-widest">
              HOW WE WORK
            </div>
          </div>
        </div>
